...
MF_AMI_ID=ami-0a2c6c9ed83ebd575
MF_INSTANCE_TYPE=t2.large
MF_PUBLIC_IP1=52.42.174.228
MF_IAM_ROLE=MQFELLOW-S3FullAccess
MF_USER_DATA_LOCATION=file:///Users/hoffman/workspaces/mq-stuff/distributed/remote/distributed-queuemanager-userdata-remote.txt
...
aws ec2 authorize-security-group-ingress --group-id $MF_SG_GRPID2 --protocol tcp --port 9000 --cidr 0.0.0.0/0
